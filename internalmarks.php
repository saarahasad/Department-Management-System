...
<style>
        ...
        <!--navbar-->
         ...
         <nav style="font-weight:bold; opacity:0.9;" class="navbar navbar-default navbar-fixed-top">
          ...
          <div style=" margin-top:90px;">
           ...
           <a href="facultyhome.php" style="margin-left:40px; margin-bottom:30px;" class="btn btn-default btn-lg">
 ...
 //   print "<h3 class='text-center'>Subjects</h3>";
    ...
    print"<th  style='font-weight:bold; color:#76323F; width:20%; ' class='text-center'>SUBJECT CODE</th>";
    print"<th style='font-weight:bold; color:#76323F;  width:60%; ' class='text-center'>NAME</th>";
     print"<th style='font-weight:bold; color:#76323F; ' class='text-center'>SEM</th>";
      print"<th style='font-weight:bold; color:#76323F; ' class='text-center'>SECTION</th>";
       print"<th style='font-weight:bold; color:#76323F; ' class='text-center'>EDIT</th>";
   print"<th style='font-weight:bold; color:#76323F; ' class='text-center'>VIEW</th>";
    ...
    //      print" <div class='front'>";
        ...
        if(strcmp(substr($s,0,1),"1")==0)
        {
         ...
         print"<td> <a href='subjectmarks.php?subcode=$subcode'>
                            <span class='glyphicon glyphicon-pencil'></span> Edit 
                            </a></td>";

         print"<td> <a href='viewiamarks.php?subcode=$subcode'>
                            View 
                            </a></td>";
