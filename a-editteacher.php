        ...
        <!--navbar-->
          ...
          <div class="wrapper">
            ...
            <div  style="width:100%;" id="content">
                ...
                <a href="a-addteacher.php" style="margin-top:-25px;" class="btn btn-default btn">
           ...
           $fid=$_GET['fid'];
            ...
            $r=mysqli_fetch_array($fa,MYSQL_ASSOC) ;
             $fpass=$r['fpassword'];
            $facultyid=$_GET['fid'];
            print"<form  action='a-saveteacher.php?facid=$facultyid' method='POST's>";
           ?>
			
                <div class="form-group" >
                <label for="name">Faculty id</label>
                <input type="text"  name="id" class="form-control" id="name" value="<?php  print $_GET['fid'];?>">
              </div>
               <div class="form-group" >
                <label for="name">Faculty name</label>
                <input type="text"  name="name" class="form-control" id="name" value="<?php  print $_GET['fname'];?>">
              </div>
              <div class="form-group" >
                <label for="name">Faculty password</label>
                <input type="password"  name="password" class="form-control" id="name" value="<?php  print $fpass;?>">
              </div>
               <div class="form-group" >
                <label for="name">Faculty email</label>
                <input type="text"  name="email" class="form-control" id="name" value="<?php  print $_GET['femail'];?>">
              </div>
            <div class="form-group" >
