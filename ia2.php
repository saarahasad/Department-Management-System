...
if (isset($_POST['submit'])) 
                    {
                        ...
                        for ($i = 0; $i < count($_POST['test1']); $i++) {
                            ...
                            $total2 =$test2+$assign2;
                             ...
                             include('db_connection.php');
                              $query="insert into Write_internals_for(usn,subcode,test2,assign2,total2) values('$usn','$subcode',$test2,$assign2,$total2);";
                            $flagAdd=mysqli_query($dbHandle,$query);
                           
                                echo "<script>
                                    alert('2nd Internal Marks successfully saved!');
            ...
            if (isset($_POST['update'])) 
                    {
                        ...
                        for ($i = 0; $i < count($_POST['test1']); $i++) {
                            ...
                            $total2 =$test2+$assign2;
                             ...
                             include('db_connection.php');
                              $query="UPDATE Write_internals_for  set test2=$test2,assign2=$assign2,total2=$total2 where usn ='$usn' and subcode='$subcode'";
                         $flagAdd=mysqli_query($dbHandle,$query);
                               if(!$flagAdd)
                            {
                              echo "<script>
                                ...
                                echo "<script>
                                    alert('2nd Internal Marks successfully updated!');
                                    window.location.href='internalmarks.php';
                                    </script>";
                            }
