            ...
            <div  style="width:100%;" id="content">
                ...
                <nav style="background:white;" class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                          ...
                          <p class="text-center" style="text-transform:uppercase;font-family: 'Montserrat', sans-serif;color:#424242;font-weight:600; font-size:30px;margin-top:15px;">ADD / REMOVE student</p>
                ...
                print"<th></th>";
                    ...
                    
                    {
                        ...
                        print"<td id='sub' style='font-size:15px;' class='text-center'>$phone</td>";
                        print"<td id='sub' style='font-size:15px;' class='text-center'>$email</td>";
                      print"<td id='sub'  style='font-size:15px;'class='text-center'>$address</td>";
                        print"<td> <a style='font-size:15px;' id='underline' href='a-editstudent.php?usn=$usn&name=$name&sem=$sem&sec=$sec&phone=$phone&email=$email&address=$address'>
                            <span class='glyphicon glyphicon-pencil'></span> Edit 
                            </a></td>";
                          print" <td><a href='a-deletestudent.php?usn=$usn'><span class='table-remove glyphicon glyphicon-remove'></span></a></td>";
                          print"</tr>";
                          $i=$i+1;
                    }
  print"</table>";
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
            ...
            <!-- content goes here -->
			<form action="a-savestudent.php" method="POST">
               ...
               <div class="form-group" >
                ...
                <input type="text"  name="usn" class="form-control" id="name" placeholder="Enter usn">
              </div>
              <div class="form-group" >
                <label for="name">Semester</label>
                <input type="text"  name="sem" class="form-control" id="name" placeholder="Enter semester">
              </div>
                 <div class="form-group" >
                <label for="name">Section</label>
                <input type="text"  name="sec" class="form-control" id="name" placeholder="Enter section">
              </div>
