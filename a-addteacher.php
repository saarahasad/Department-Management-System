          ...
          <div class="wrapper">
            ...
            <div  style="width:100%;" id="content">
                ...
                <nav style="background:white;" class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                          ...
                          <p class="text-center" style="text-transform:uppercase;font-family: 'Montserrat', sans-serif;color:#424242;font-weight:600; font-size:30px;margin-top:15px;">ADD / REMOVE  faculty member</p>
                ...
                <?php
                    ...
                    // print"<th></th>";
                    print" <th><a id='underline' style=' color: #070;cursor:pointer;' data-toggle='modal' data-target='#squarespaceModal'> <span style='   color: #070;'class=' glyphicon glyphicon-plus'> </span>Add</a> </th>";
                   print"<th></th>";

                    print"</tr></thead>";
                     $query1="Select * from Faculty_members where  Faculty_id!='F000';";
                    ...
                    
                    {
                        ...
                        $fid=$rowfaculty['Faculty_id'];
                        $femail=$rowfaculty['f_email'];
                        print "<tr>";
                        print"<td class='text-center'>$i</td>";
                        print"<td id='sub'  class='text-center'>$fid</td>";
                        print"<td id='sub'  class='text-center'>$fname</td>";
                        print"<td id='sub'  class='text-center'>$femail</td>";
                        print"<td> <a id='underline' href='a-editteacher.php?fid=$fid&fname=$fname&femail=$femail'>
                            <span class='glyphicon glyphicon-pencil'></span> Edit 
                            </a></td>";
                        print" <td><a href='a-deleteteacher.php?fid=$fid'><span class='table-remove glyphicon glyphicon-remove'></span></a></td>";
                        print"</tr>";
                        $i=$i+1;
                    }
                     print"</table>";
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
            ...
            <!-- content goes here -->
			<form action="a-saveteacher.php" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text"  name="id" class="form-control" id="id" placeholder="Eg. F001">
              </div>
               <div class="form-group" >
