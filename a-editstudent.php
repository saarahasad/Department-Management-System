        ...
        <!--navbar-->
         <link rel="stylesheet" href="navbarstyle.css">
          ...
          <div class="wrapper">
                ...
                <nav style="background:white;" class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                          ...
                          <p class="text-center" style="text-transform:uppercase;font-family: 'Montserrat', sans-serif;color:#424242;font-weight:600; font-size:30px;margin-top:15px;">Edit Student Details</p>
           ...
           <?php
           $usn= $_GET['usn'];
           print"<form action='a-savestudent.php?usn=$usn' method='POST'>";
           ?>
              ...
              <div class="form-group" >
                ...
                <input type="text"  name="sem" class="form-control" id="name"  value="<?php  print $_GET['sem'];?>">
              </div>
                 <div class="form-group" >
                <label for="name">Section</label>
                <input type="text"  name="sec" class="form-control" id="name" value="<?php  print $_GET['sec'];?>">
              </div>
              
                 <div class="form-group" >
                <label for="name">Phone</label>
                <input type="text"  name="phone" class="form-control" id="name"  value="<?php  print $_GET['phone'];?>">
              </div>
               <div class="form-group" >
                <label for="name">Email</label>
                <input type="text"  name="email" class="form-control" id="name" value="<?php  print $_GET['email'];?>">
              </div>
               <div class="form-group" >
                <label for="name">Address</label>
                <input type="text"  name="address" class="form-control" id="name" value="<?php  print $_GET['address'];?>">
              </div>
              <div class="form-group" >
