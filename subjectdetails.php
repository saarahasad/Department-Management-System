           ...
           <div  style="opacity:0.8; margin-bottom:40px;padding:5px; color:black;">
                            ...
                            <?php
                             $fname=$_GET['fname'];
                                ...
                                print $row['sub_name'];
                                print"  </div>";  
                                 print"<p class='text-center'>Professor $fname</p>";
                                ...
                                if(strcmp(substr($s,0,1),"1")==0)
                                {
                                 ...
                                 print"<p class='text-center'>Classes held: $max</p>";
   ...
   print"";
    ...
    print"<th class='text-center'>USN</th>";
     print"<th class='text-center'>NAME</th>";
      print"<th class='text-center'>CLASSES ATTENDED</th>";
       print"<th class='text-center'>ATTENDANCE %</th>";
    print"</tr></thead>";

    print"<tbody class='table-hover'>";
    include('db_connection.php');
     $query2="SELECT fkusn,name FROM Tracker,Students where  fkusn=usn and fksubcode='$subcode'; ";
    ...
    while($rows=mysqli_fetch_array($list,MYSQL_ASSOC))
    {
        ...
        $name=$rows['name'];  
        include('db_connection.php');
        $query3="select count(hours) from Attend where usn_fk='$usn' and attendance='P'	and subcode_fk ='$subcode';";  
       $countno=mysqli_query($dbHandle,$query3);     
       $rowcount=mysqli_fetch_array($countno,MYSQL_ASSOC);
       $count=$rowcount['count(hours)'];
        print "<tr>";
         ...
         if($max!=0)
            ...
            if($percentage>=75)
            {
               ...
               print"<td ' class='text-center'> $count</td>";
               print"<td ' class='text-center'> $percentage %</td>";
            }
            else
            {
                print"<td  style='background: #f2b632;'  class='text-center'>$i</td>";
                print"<td  style='background: #f2b632;'  class='text-center'>$usn</td>";
               print"<td  style='background: #f2b632;' class='text-center'> $name</td>";
               print"<td  style='background: #f2b632;' class='text-center'> $count</td>";
