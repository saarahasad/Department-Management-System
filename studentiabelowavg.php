                ...
                <nav  style="background:#E0E0E0;" class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                         ...
                         <p class="text-center" style="text-transform:uppercase;font-family: 'Montserrat', sans-serif;color:#424242;font-weight:600; font-size:30px;margin-top:15px;">Students with Below average Internal Assessment marks list</p>
                ...
                <?php
                    ...
                    {  
                        ...
                        while($count<$tot)
                        {
                            $sub=$subcode[$count];
                            include('db_connection.php');
                            $query1="select total1,total2,total3 FROM Write_internals_for where usn='$usn'	and subcode ='$sub';";  
                            $ia=mysqli_query($dbHandle,$query1);    
                            $rowia=mysqli_fetch_array($ia,MYSQL_ASSOC)  ;
                           $a=$rowia['total1'];
                           $b=$rowia['total2'];
                           $c=$rowia['total3'];
                           ...
                           $avg=$total/2;
                           if($avg<12)
                             print" <td style='background: #f2b632;'  class='text-center'>$avg </td>";
                             else
                               print" <td class='text-center'>$avg </td>";
                            $count=$count+1;
