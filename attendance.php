...
<style>
    ...
    <body>
        ...
        <nav style="font-weight:bold; opacity:0.9;" class="navbar navbar-default navbar-fixed-top">
          ...
          <div style=" margin-top:90px;">
           ...
           <a href="facultyhome.php" style="margin-left:40px; margin-bottom:20px;" class="btn btn-default btn-lg">
 ...
 //   print "<h3 class='text-center'>Subjects</h3>";
    ...
    while($row=mysqli_fetch_array($objList,MYSQL_ASSOC))
    {
        ...
        $s="$subcode";
         //  print"<div class='flip-container ' ontouchstart='this.classList.toggle('hover');'>";
       //  print" <div class='flipper'>";
    //      print" <div class='front'>";

        print"<table class='table-fill'> ";
          print"<thead style=' background: url('image/ruled.jpg');'>  ";
       
        print "<tr class='clickable-row' data-href='subjectclasses.php?subcode=$subcode'>";
   ...
   //   print"</div>";
     /*     print" <div class='back'>";
        ...
        print "<tr>";
        print"<td   id='backflip' style='font-weight:bold;width: 20%;' class='text-left'>$subcode</td>";
        print"<td id='backflip'   style='font-weight:bold; color:black;width: 60%;  background-size: 100%;' class='text-left'><a id='sub' style='font-weight:bold; color:black;' href='subjectclasses.php?subcode=$subcode'>$subname</a></td>";
        if(strcmp(substr($s,5,1),1)==0)
        {
          
            print"<td  id='backflip' style='font-weight:bold' class='text-left'>1</td>";
        }
        if(strcmp(substr($s,5,1),2)==0)
        {
          
            print"<td  id='backflip' style='font-weight:bold' class='text-left'>2</td>";
            
        }
        if(strcmp(substr($s,5,1),3)==0)
        {
          
            print"<td  id='backflip' style='font-weight:bold' class='text-left'>3</td>";
        }
        if(strcmp(substr($s,5,1),5)==0)
        {
          
            print"<td  id='backflip' style='font-weight:bold' class='text-left'>5</td>";
        }
