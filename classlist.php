    ...
    <body>
        ...
        <div class="container"><h2>Example 3 </h2></div>
            <div id="exTab3" class="container">	
                ...
                <form   style="padding:25px;"  action="attendancesave.php" method="POST">
                <table>
                    ...
                    <?php
                        ...
                        while($row=mysqli_fetch_array($objList,MYSQL_ASSOC))
                        {
                           ...
                           print"<input type='hidden' value='$subcode' name='subcode[]'/>";
                            ...
                            print" <label class='radio'><td class='text-center' id='rows'  style=' border-bottom:1pt solid black;color:black;'> <input id='green' style='height:30px;   background-color: green;' value='P' type='radio' checked name='attendance[$i]'/></td>";
                        
                            print"<td  class='text-center'id='rows'  style=' border-bottom:1pt solid black;color:black;'> <input style='height:30px;'  value='A'  id='red'  type='radio' name='attendance[$i]'/></td> </label>";
                    ...
                    ?>
                    <tr>              
                        <td class="text-center" colspan="7" ><button type='submit' name="submit" id="sub" class='btn btn-default'  style="width:300px; margin-top:40px;">Submit</button></td>
                    </tr>
                </table>
                </form>
