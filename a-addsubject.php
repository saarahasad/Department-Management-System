            ...
            <div  style="width:100%;" id="content">
                ...
                <nav style="background:white;" class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                          ...
                          <p class="text-center" style="text-transform:uppercase;font-family: 'Montserrat', sans-serif;color:#424242;font-weight:600; font-size:30px;margin-top:15px;">ADD / REMOVE SUBJECT</p>
                ...
                <?php
                    ...
                    print"<th class='text-center'>SL. </th>";
                     print"<th class='text-center'>SUBCODE</th>";
                      print"<th class='text-center'>SECTION</th>";
                    print"<th class='text-center'>NAME</th>";
                    print"<th class='text-center'>FACULTY</th>";
                    // print"<th></th>";
                    print" <th><a id='underline'style=' color: #070;cursor:pointer;'  data-toggle='modal' data-target='#squarespaceModal'> <span style='  margin-left: -13px;  color: #070;'class=' glyphicon glyphicon-plus'></span>Add</a> </th>";
                print"<th></th>";
                    print"</tr></thead>";
                     $query1="SELECT subcode, sub_name,fid, f_name FROM Subjects LEFT JOIN Faculty_members on fid=Faculty_ID  ";
                    $f=mysqli_query($dbHandle,$query1);
                    $i=1;
                    while($rowfaculty=mysqli_fetch_array($f,MYSQL_ASSOC))
                    
                    {
                        $fname=$rowfaculty['f_name'];
                        $fid=$rowfaculty['fid'];
                        $subname=$rowfaculty['sub_name'];
                         $subcode=$rowfaculty['subcode'];
                         $s="$subcode";
                         $a=substr($s,1,10);

                        print "<tr>";
                        print"<td class='text-center'>$i</td>";
                        print"<td id='sub'  class='text-center'>$a</td>";
                         if(strcmp(substr($s,0,1),"1")==0)
                            {
                            
                                print"<td  class='text-center'>1</td>";
                            }
                            else{
                            print"<td    class='text-center'>2</td>";
                            }
                         print"<td id='sub'  class='text-center'>$subname</td>";
                          print"<td id='sub'  class='text-center'>P. $fname</td>";
                           print"<td> <a id='underline' href='a-editsubject.php?subcode=$subcode&fname=$fname&fid=$fid&subname=$subname'>
                            <span class='glyphicon glyphicon-pencil'></span> Edit 
                            </a></td>";
                          print" <td><a href='a-deletesubject.php?subcode=$subcode'><span class='table-remove glyphicon glyphicon-remove'></span></a></td>";
                          print"</tr>";
                          $i=$i+1;
                    }
  print"</table>";
  ...
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
            ...
            <!-- content goes here -->
			<form action="a-savesubject.php" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcode" id="exampleInputEmail1" placeholder="Enter subcode">
              </div>
               <div class="form-group">
            ...
            <div class="form-group" >
                <input type="hidden"  name="edit" class="form-control" id="name" value="0">
              </div>
